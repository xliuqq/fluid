...
func TestTimeleft(t *testing.T) {
	...
	testcase := []struct {
	...
	}{
		{
			...
			// operation:         dataoperation.BuildMockDataloadOperationReconcilerInterface(datav1alpha1.Load),
			operation:      dataoperation.BuildMockDataloadOperationReconcilerInterface(datav1alpha1.Load, &ttl),
			validRemaining: true,
			wantErr:        false,
		},
		{
...
func TestGetTTL(t *testing.T) {
	...
	testcase := []struct {
		...
		},
		{
			name:      "no ttl",
			dataload:  datav1alpha1.DataLoad{},
			operation: dataoperation.BuildMockDataloadOperationReconcilerInterface(datav1alpha1.Load, nil),
			ttl:       nil,
			wantErr:   false,
		},
		{
			...
			dataload:          datav1alpha1.DataLoad{},
			dataoperationType: datav1alpha1.Migrate,
			operation:         dataoperation.BuildMockDataloadOperationReconcilerInterface(datav1alpha1.Migrate, nil),
			ttl:               nil,
			wantErr:           true,
		},
	}
